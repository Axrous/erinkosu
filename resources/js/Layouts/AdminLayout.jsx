    ...
    <>
      ...
      >
        <div class="h-full px-3 py-2 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <button
            type="button"
            className="inline-flex items-center md:hidden text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
            onClick={(e) => setNavbar(!navbar)}
          >
            <span class="sr-only">Open sidebar</span>
            <svg
